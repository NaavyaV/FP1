...
function setup() {
  ...
  truckImg = loadImage('Images/Ambulance.png')
  roadImg = loadImage('Images/RoadImg.png')
  fuelImg = loadImage('Images/Fuel.png')
  policeCImg = loadImage('Images/Police.png')
  coolCar1Img  = loadImage('Images/Mini_truck.png')
  car2Img = loadImage('Images/Mini_van.png')
  ...
  truckRandomImg = [policeCImg, coolCar1Img, car2Img];
  ...
  createCanvas(displayWidth - 800, displayHeight - 200);
  ...
  fuel = new Fuel((displayWidth - (Math.round(random(fuelRandomNum))) * 100)/2, -truckRandomY, 60, 60, 10, fuelImg);
...
function draw() {
  ...
  imageMode(CENTER)
  scrBackg = image(roadImg, (displayWidth - 800)/2, BackgY, 575, 800);
  scrBackg2 = image(roadImg, (displayWidth - 800)/2, BackgY2 - 800, 575, 800);
